...
PATH = pathlib.Path(
    'C:/Users/SFValidation3/Desktop/Mark Mikofski/SURFRAD/Fort_Peck_MT')
YEARS = list(str(y) for y in PATH.iterdir())

TMY2_PATH = 'C:/Users/SFValidation3/Desktop/Mark Mikofski/SURFRAD/94008.tm2'
TMY3_PATH = 'C:/Users/SFValidation3/Desktop/Mark Mikofski/SURFRAD/727680TYA.CSV'
...
ax[1].set_title(
    ...
    f'\nPSM3({psm3quantile:g}%) = {psm3eyear:g}[kWh], TMY2 = {tmy2eyear:g}[kWh], TMY3 = {tmy3eyear:g}[kWh]')
plt.tight_layout()
